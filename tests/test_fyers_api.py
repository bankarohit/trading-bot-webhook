...
class TestFyersAPI(unittest.TestCase):
    ...
    def test_retry_api_call_executes_function(self):
        """_retry_api_call executes the wrapped coroutine."""
        calls = []
        ...
        result = asyncio.run(app.fyers_api._retry_api_call(dummy_func, retries=1))
